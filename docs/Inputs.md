...
* [procoders/ra-input-json](https://github.com/procoders/ra-input-json): a JSON input using [react-json-editor-ajrm](https://github.com/AndrewRedican/react-json-editor-ajrm), useful for editing and validating JSON structures
